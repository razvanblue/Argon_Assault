...
public class Lurker : Agent
{
    ...
    {
        rewardMultiplier = 0.5f / (2 * searchRadius * MaxStep);         // The divident is the maximum reward over MaxStep steps
    }
    ...
    public override void OnActionReceived(float[] vectorAction)
    {
        ...
        {
            AddReward(0.8f);                                                                // Target reached reward
